...
const server = new GraphQLServer({
  schema,
  context: ({ request }) => ({ request, isAuthenticated }) //이건 context안에 req 가 있고 그 안에 passport의 request가 있는데 우리가원하는건 passport안에 request니까 내부의 request를 context로 리턴해주는거임 즉 context.req.request를 리턴한다 이거임
});
